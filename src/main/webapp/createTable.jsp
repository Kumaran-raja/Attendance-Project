...
<%
    ...
    if (dept != null && dept.matches("^[A-Za-z0-9_]+$")) {
        ...
        try (Connection connect = DriverManager.getConnection("jdbc:mysql://localhost:3306/ATTENDANCE", "root", "Kumaranraja@22_02$")) {
            ...
            // Create new table if it doesn't exist (now includes ATTENDANCE_DATE and NAME)
            ...
            // Copy register numbers and names if not already present and set ATTENDANCE_DATE as today
            String insertSQL = "INSERT IGNORE INTO " + newTableName + 
                   " (REGISTER_NO, NAME, ATTENDANCE_DATE, HOUR_1, HOUR_2, HOUR_3, HOUR_4, HOUR_5) " + 
                   "SELECT REGISTER_NO, NAME, CURDATE(), '', '', '', '', '' FROM " + dept;
