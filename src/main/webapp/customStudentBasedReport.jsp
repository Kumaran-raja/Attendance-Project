    ...
    <div class="table_container">
        <table border="1" style="width: 80%; margin: auto; border-collapse: collapse;">
                ...
                try {
                    ...
                    while (!startDate.after(endDate)) {
                        ...
                        if (rollNo != null && !rollNo.trim().isEmpty()) {
                            queryBuilder.append(" WHERE REGISTER_NO = '" + rollNo + "'");
                        }
                        first = false;
            ...
            <% 
                        ...
                        if (!dataExists) {
                            out.println("<tr><td colspan='7' style='text-align:center; color:red;'>No records found for the selected criteria.</td></tr>");
                        }
